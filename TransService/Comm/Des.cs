...
using System.Text;
    ...
    /// </summary>
namespace TransService.COMM{
    public class Des
    {
        #region 预定义数组

        static int[] BitIP ={ 57, 49, 41, 33, 25, 17,  9,  1,
        ...
        static int[] BitCP = { 39,  7, 47, 15, 55, 23, 63, 31,
        ...
        static int[] BitExp ={ 31, 0, 1, 2, 3, 4, 3, 4, 5, 6, 7, 8, 7, 8, 9,10,
                        11,12,11,12,13,14,15,16,15,16,17,18,19,20,19,20,
                        21,22,23,24,23,24,25,26,27,28,27,28,29,30,31,0  
                      };

        static int[] BitPM ={ 15, 6,19,20,28,11,27,16, 0,14,22,25, 4,17,30, 9,
                        1, 7,23,13,31,26, 2, 8,18,12,29, 5,21,10, 3,24
                     };


        static int[] BitPMC1 = { 56, 48, 40, 32, 24, 16,  8,
                           0, 57, 49, 41, 33, 25, 17,
                           9,  1, 58, 50, 42, 34, 26,
                          18, 10,  2, 59, 51, 43, 35,
        ...
        static int[] BitPMC2 ={ 13, 16, 10, 23,  0,  4,
                          2, 27, 14,  5, 20,  9,
                         22, 18, 11,  3, 25,  7,
                         15,  6, 26, 19, 12,  1,
                         40, 51, 30, 36, 46, 54,
        ...
        static byte[][] subKey = new byte[16][];

        private static void initPermutation(ref byte[] inData)
        {
        ...
        private static void conversePermutation(ref byte[] inData)
        {
            byte[] newData = new byte[8] { 0, 0, 0, 0, 0, 0, 0, 0 };
            for (int i = 0; i < 64; i++)
            {
        ...
        private static void expand(byte[] inData, ref byte[] outData)
        {
            for (int i = 0; i < 6; i++)
            {
                outData[i] = 0;
        ...
        private static void permutation(ref byte[] inData)
        {
        ...
        private static void permutationChoose1(byte[] inData, ref byte[] outData)
        {
            for (int i = 0; i < 7; i++)
            {
                outData[i] = 0;
        ...
        private static void permutationChoose2(byte[] inData, ref byte[] outData)
        {
            if (outData == null)
            {
        ...
        private static void cycleMove(ref byte[] inData, byte bitMove)
        {
        ...
        private static void encry(byte[] inData, byte[] insubKey, ref byte[] outData)
        {
