...
namespace Model
{
    ...
    public class Config
    {
        ...
        {
            get {                 
                return serverAdd+"/SumPosWebService.asmx"; }
        }
        ...
        public string offLineSale;
        /// <summary>
        /// 是否允许脱机使用
        /// </summary>
        public bool OffLineSale
        {
            get 
            {
                if (offLineSale == "1")
        ...
        {
            get { return dataSaveDays; }
            set { dataSaveDays = value; }
        }
        ...
        public string PosId
        {
            get
            {
                return Des.EncryStrHex(netMac, posNo);
            }
        }
    }
}
