...
namespace Action.SqlServer
{
    ...
    public class SqlServerCzCarkAction:SqlServerBaseAction
    {
        ...
        /// <returns></returns>
        public Model.CzCard getCzCardByZh(string inCardno)
        {
        ...
        /// <returns></returns>
        public Model.CzCard getCzCardByKh(string outCardno)
        {
            Model.CzCard czCard = new Model.CzCard();

            #region 组装sql语句
            string sqlStr = "select * from tCzkCard where outcardno='" + outCardno + "'";
            #endregion
