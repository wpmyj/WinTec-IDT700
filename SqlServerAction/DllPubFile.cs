...
using System.Collections;
    public class DllPubFile
    {
        ...
        public static string CzkDecryStr(string str)
        {
            ...
            result = Encoding.Default.GetString(resultb);
            result =Encoding.Default.GetString( DecryptStr(result, key));
        ...
        public static string EncryStrHex(string str, int key)
        {
            ...
            try
            {
                TempResult =Encoding.Default.GetString(EncryptStr(str, key));
                strResult = "";
        ...
        public static string DecryStrHex(string strHex, int key)
        {
            ...
            try
            {
                ...
                for (i = 0; i < strHex.Length / 2; i++)
                {
                    ...
                    str=str+Encoding.Default.GetString(new byte[]{b});
                }
                result =Encoding.Default.GetString(DecryptStr(str,key));
            }
            catch
            {
                result = "";
